...
WSW.config = {
  ...
  // ⚙️ الحسابات (تسجيل الدخول وإنشاء الحساب ولوحات الطالب والإدارة)
  // false = الموقع تعريفي فقط: كل المحتوى العام ظاهر، وصفحتا الدخول والتسجيل تعرضان رسالة "قريبًا".
  // تُفعَّل (true) فقط بعد ربط الـBackend الحقيقي.
  accountsEnabled: false,
  registrationOpensText: 'مع بداية أسبوع الفضاء العالمي',
